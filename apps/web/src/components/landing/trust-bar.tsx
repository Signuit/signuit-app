...
const logos: LogoItem[] = [
	{
		node: <span className="font-semibold">Canton</span>,
		href: "https://canton.network",
		title: "Canton",
	},
	{ node: <span className="font-semibold">Daml</span>, href: "https://daml.com", title: "Daml" },
	{
		node: <span className="font-semibold">Splice</span>,
		href: "https://www.hyperledger.org",
		title: "Splice",
	},
	{
		node: <span className="font-semibold">Hyperledger</span>,
		href: "https://www.hyperledger.org",
		title: "Hyperledger",
	},
		...
		<section id="trust" className="border-y border-slate-800/70 bg-slate-950/70 px-6 py-12">
			<div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
				...
				<LogoLoop
					...
					fadeOut
					fadeOutColor="#020617"
					ariaLabel="SignUIT ecosystem logos"
				/>
			</div>
		</section>
	);
