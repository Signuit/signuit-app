		...
		>
			...
			<JudgingSection title="Nexus Framework: Separate but Connected">
				<JudgingCard>
					<p className="text-lg leading-relaxed mb-6 text-foreground">
						...
						(Apache 2.0), it serves as the technical foundation powering SignUIT CollateralRouter —
						connecting Daml smart contracts to modern React frontends with end-to-end type safety.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="p-4 bg-muted/30 rounded-lg">
							...
							<p className="text-sm text-muted-foreground">
								Auto-generated TypeScript bindings from Daml contracts. Zero runtime errors when
								calling ledger templates.
							</p>
						</div>
						<div className="p-4 bg-muted/30 rounded-lg">
							<p className="font-semibold text-foreground mb-2">React 19 + TanStack Native</p>
							<p className="text-sm text-muted-foreground">
								Native TanStack Query integration with typed query keys, optimistic mutations, and
								streaming updates.
							</p>
						</div>
						<div className="p-4 bg-muted/30 rounded-lg">
							...
							<p className="text-sm text-muted-foreground">
								Routes reads to Participant Query Store (SQL) for 10x faster queries, falling back
								to Canton HTTP when needed.
							</p>
						</div>
						<div className="p-4 bg-muted/30 rounded-lg">
							<p className="font-semibold text-foreground mb-2">Secure Session Management</p>
							<p className="text-sm text-muted-foreground">
								AES-GCM encrypted, HttpOnly, SameSite=Lax cookies with automatic silent refresh
								before expiry.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start gap-4">
						...
						<div>
							<p className="font-semibold text-foreground mb-2">
								Canton Developer Survey 2026 Alignment
							</p>
							<p className="text-sm text-muted-foreground leading-relaxed">
								Nexus Framework directly addresses the{" "}
								<strong>#1 most requested missing tool</strong>
								...
								from an Ethereum background, they expect the same DX maturity as wagmi/viem. Nexus
								brings that to Canton.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="space-y-6">
					<JudgingCard title="Performance Benchmarks">
						...
						<p className="text-sm text-muted-foreground mt-6 leading-relaxed">
							<strong className="text-foreground">Baseline:</strong> Manual collateral selection
							takes 30+ minutes per margin call. SignUIT reduces this to 3 seconds — a 600x
							improvement. Benchmarked against the demo scenario in <code>DEMO.md</code>.
						</p>
					</JudgingCard>
					...
					<JudgingCard title="Technology Stack & Architecture">
						<div className="space-y-4">
							<Bullet>
								<strong>Nexus Framework:</strong> Type-safe full-stack SDK for Canton (runtime,
								auth, data layer, UI components, Daml integration)
							</Bullet>
							<Bullet>
								<strong>Canton Network:</strong> Institutional blockchain for atomic settlement with
								sub-transaction privacy
							</Bullet>
							<Bullet>
								<strong>Daml Smart Contracts:</strong> Financial-grade contracts for
								CollateralPolicy, CollateralHolding, MarginCall, RoutingSuggestion, AllocationRecord
							</Bullet>
							<Bullet>
							...
							<Bullet>
								<strong>Bun + SQLite:</strong> High-performance runtime with built-in database,
								WebSocket support, and CSS bundling
							</Bullet>
						</div>
					</JudgingCard>
				</div>
			...
			<JudgingSection title="Market Validation Data">
				...
				<JudgingCard title="Canton Network Growth & Ecosystem">
					<div className="space-y-4">
						<Bullet>
							<strong>Broadridge DLR:</strong> Processes{" "}
							<strong>trillions in tokenized UST repo</strong>
							every month on Canton Network — validating institutional demand for on-chain
							collateral operations.
						</Bullet>
						<Bullet>
							<strong>Tokenized Treasuries surpass $10bn globally</strong> (Markets Media, January
							2026) — on-chain collateral market is growing rapidly.
						</Bullet>
						<Bullet>
							<strong>Ctrl Alt:</strong> Tokenized over <strong>$1.4 billion in assets</strong> on
							Canton (April 2026) — spanning real estate, private credit, funds, and commodities.
						</Bullet>
						<Bullet>
							<strong>CCTools:</strong> 23,000+ registered users in the Canton ecosystem community
							platform.
						</Bullet>
						<Bullet>
							<strong>DTCC partnership:</strong> Exploring tokenization of DTC-custodied U.S.
							Treasury securities on Canton — a signal of growing institutional commitment to
							on-chain assets.
						</Bullet>
						<Bullet>
							<strong>Digital Asset $135M funding:</strong> Validates long-term investment in Canton
							Network ecosystem growth and developer tooling.
						</Bullet>
						<Bullet>
							<strong>Zero native collateral routing engines</strong> currently exist on Canton —
							SignUIT addresses a clear tooling gap.
						</Bullet>
					</div>
				</JudgingCard>
			</JudgingSection>
				...
				<JudgingCard>
					<p className="text-muted-foreground mb-6 leading-relaxed">
						...
						<strong className="text-foreground">
							{" "}
							Canton-native, policy-based collateral routing
						</strong>
						:
					</p>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="p-5 bg-muted/30 rounded-lg">
							<p className="font-semibold text-foreground mb-2">
								Traditional SaaS (e.g., FIS, Calypso)
							</p>
							<p className="text-sm text-muted-foreground leading-relaxed">
								Legacy on-premise or generic cloud. No Canton integration. No sub-transaction
								privacy. High implementation cost.
							</p>
						</div>
						<div className="p-5 bg-muted/30 rounded-lg">
							<p className="font-semibold text-foreground mb-2">
								On-chain Platforms (e.g., Centrifuge)
							</p>
							<p className="text-sm text-muted-foreground leading-relaxed">
								Focus on asset tokenization, not collateral routing. No policy engine. No CTD
								algorithm. Public blockchains.
							</p>
						</div>
						<div className="p-5 bg-primary/5 border border-primary/10 rounded-lg md:col-span-2">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								<strong className="text-foreground">
									Canton-native, sub-transaction privacy, policy engine, yield-preserving CTD
									algorithm, human-in-the-loop approval,
								</strong>{" "}
								and immutable audit trail. First and only.
							</p>
						</div>
					</div>
				</JudgingCard>
			...
			<JudgingSection title="Open Source & Community">
				...
				<p className="text-sm text-muted-foreground mt-4 leading-relaxed text-center">
					<strong className="text-foreground">Nexus Framework</strong> is early stage and actively
					developed. Post-launch targets: 500+ weekly npm downloads, 200+ GitHub stars, 2+ community
					integrations.
				</p>
			</JudgingSection>
		</JudgingLayout>
