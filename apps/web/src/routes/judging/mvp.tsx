		...
		>
					...
					<div className="flex items-start gap-6">
						...
						<div className="flex-1">
							...
							<p className="text-muted-foreground mb-6 leading-[1.7] max-w-prose">
								A live, interactive dashboard demonstrating the full collateral routing workflow.
								Built with React + TanStack Query + Nexus Framework.
							</p>
							<div className="flex flex-wrap gap-3">
								...
								<Button
									variant="outline"
									className="border-border/40 hover:border-primary/30 transition-all duration-500"
									asChild
								>
									<a
			...
			<JudgingSection title="Demo Scenarios">
				<JudgingCard title="Scenario 1: Basic Margin Call Routing" index={1}>
					<div className="max-w-prose space-y-4">
						...
						<Bullet>
							...
							counterparty eligibility (PrimeBank accepts T-Bills, Corporate Bonds, ETFs), checks
							LTV limits (&lt;70%), and excludes restricted assets
						</Bullet>
						<Bullet>
							<strong>CTD Selection:</strong> Algorithm prioritizes lowest opportunity cost (3.2%
							yield-bearing assets last), sends $10M T-Bills + $5M Corporate Bonds
						</Bullet>
						<Bullet>
							<strong>Human Approval:</strong> Treasury ops reviews suggestion in dashboard, clicks
							"Approve"
						</Bullet>
						<Bullet>
							<strong>Audit:</strong> AllocationRecord created on Canton with full recommendation
							trail, timestamp, and approver identity
						</Bullet>
					</div>
					<div className="mt-5 p-4 bg-primary/5 border border-primary/10 rounded-xl flex items-start gap-3 animate-fade-in-up stagger-3">
						...
						<span className="text-sm text-muted-foreground leading-[1.7]">
							<strong className="text-foreground">Result:</strong> 3 seconds vs. 30 minutes. $15M
							routed. $2,300/day yield preserved. Immutable audit created.
						</span>
					</div>
				</JudgingCard>
				...
				<JudgingCard title="Scenario 2: After-Hours Emergency" className="mt-6" index={2}>
					<div className="max-w-prose space-y-4">
						<Bullet>
							<strong>Trigger:</strong> 2:47 AM — flash crash triggers $50M margin call from 3
							counterparties simultaneously
						</Bullet>
						<Bullet>
							<strong>System Response:</strong> SignUIT processes all 3 calls in parallel, no human
							intervention required for first-pass recommendations
						</Bullet>
						<Bullet>
							<strong>CTD Selection:</strong> Optimizes across all 3 calls to minimize total
							opportunity cost, avoids sending same asset to multiple counterparties
						</Bullet>
						<Bullet>
							<strong>Human Review:</strong> On-call manager receives mobile notification, reviews
							batch approval, clicks confirm
						</Bullet>
					</div>
					<div className="mt-5 p-4 bg-primary/5 border border-primary/10 rounded-xl flex items-start gap-3 animate-fade-in-up stagger-4">
						<CheckCircleIcon className="size-5 text-primary shrink-0 mt-0.5" />
						<span className="text-sm text-muted-foreground leading-[1.7]">
							<strong className="text-foreground">Result:</strong> All 3 calls resolved in &lt;10
							seconds. No overnight team wake-ups. Zero errors.
						</span>
					</div>
				</JudgingCard>
			</JudgingSection>
					...
					{[
						{
							...
							desc: "Interactive demo with real CTD computation, policy checks, and approval workflow.",
							link: "/dashboard",
							external: false,
						},
						{
							...
							desc: "Full source code: Daml smart contracts, React frontend, Nexus Framework integration.",
							link: "https://github.com/Signuit/signuit-app",
							external: true,
						},
						{
							icon: PlayIcon,
							title: "Pitch Deck",
							desc: "9-slide dynamic pitch deck. Navigate with arrow keys. Built with React + Tailwind.",
							link: "/pitch",
							external: false,
						},
						{
							icon: TerminalIcon,
							title: "Daml Contracts",
							desc: "Smart contract templates: CollateralRouter.daml, SeedData.daml demo script.",
							link: "https://github.com/Signuit/signuit-app/tree/main/sandbox/daml",
							external: true,
						},
					].map((item, i) => {
								...
								<CardContent className="pt-6">
									<div className="flex items-start gap-4">
										...
										<div>
											...
											<p className="text-sm text-muted-foreground mb-4 leading-[1.7]">
												{item.desc}
											</p>
											<Button
												variant="outline"
